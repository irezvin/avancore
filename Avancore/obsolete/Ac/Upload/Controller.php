...
class Ac_Upload_Controller extends Ac_Legacy_Controller {
    ...
    var $_templateClass = 'Ac_Upload_Controller_Template';
    ...
    var $defaultUploadManagerClass = 'Ac_Upload_Manager';
    ...
    function getFileData() {
        ...
        $f = Ac_Util::getUploadedFilesByHierarchy();
        $fileData = Ac_Util::getArrayByPath($f, $paramPath, false);
        return $fileData;
    }
