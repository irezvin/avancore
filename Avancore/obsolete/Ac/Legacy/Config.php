...
class Ac_Legacy_Config {
    ...
    function Ac_Legacy_Config($configFilePath, $configOptions = array()) {
        ...
        Ac_Util::simpleBindAll($configOptions, $this);
        if ($this->_configFilePath) $configOptions = Ac_Util::m($cf = $this->_loadConfigFile($this->_configFilePath), $co = $configOptions);
        $this->_configOptions = $configOptions;
        Ac_Util::simpleBindAll($configOptions, $this);
    }
