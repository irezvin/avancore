...
/**
 * Response_Part is an aggregate of Ac_Legacy_Controller_Response that is evaluated only on response output.
 * 
...
class Ac_Legacy_Controller_Response_Part extends Ac_Prototyped {
     ...
     */
    function handleResponseWakeup(Ac_Legacy_Controller_Response $response) {
    }
