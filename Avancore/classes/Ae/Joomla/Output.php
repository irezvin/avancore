...
class Ae_Joomla_Output extends Ae_Output {
    ...
    /**
     * @param Ae_Controller_Response_Html $response
     */
    function outputResponse(Ae_Controller_Response_Html $response) {
