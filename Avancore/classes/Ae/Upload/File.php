...
class Ae_Upload_File {
    ...
    function Ae_Upload_File($options = array()) {
        Ae_Util::bindAutoparams($this, $options, true, array('uploadManager'));
    }
    ...
    /**
     * @param Ae_Upload_Manager $manager
     */
    function setUploadManager(& $manager) {
        if ($manager !== false && !is_a($manager, 'Ae_Upload_Manager')) trigger_error('$manager should be either FALSE or an instance of Ae_Upload_Manager');
    ...
    function getViewLinkElement($body, $attribs = array()) {
        ...
        $res = Ae_Util::mkElement('a', $body, $attribs);
        return $res;
    }
