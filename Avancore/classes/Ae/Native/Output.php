...
class Ae_Native_Output extends Ae_Output {
    ...
    function Ae_Native_Output($options = array()) {
        Ae_Util::bindAutoparams($this, $options);
    }
    
    /**
     * @param Ae_Controller_Response_Html $r
     */
    function outputResponse(Ae_Controller_Response_Html $r) {
        
        if (class_exists('Ae_Controller_Response_Global', false)) {
            $glob = Ae_Controller_Response_Global::getInstance();
