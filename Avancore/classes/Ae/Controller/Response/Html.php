...
Ae_Dispatcher::loadClass('Ae_Controller_Response_Http');

class Ae_Controller_Response_Html extends Ae_Controller_Response_Http {
    ...
    /**
     * @param Ae_Controller_Response_Html $subResponse
     */
    ...
    function __sleep() {
        if (class_exists('Ae_Controller_Response_Global', false)) {
            // We have to save global response data when response is serialized 
            if ($this !== Ae_Controller_Response_Global::r()) {
                Ae_Controller_Response_Global::i()->pourToResponse($this);
            }
        }
        $res = parent::__sleep();
        return $res;
