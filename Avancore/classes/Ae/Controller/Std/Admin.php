...
class Ae_Controller_Std_Admin extends Ae_Controller_Std_Web {
	
	var $_templateClass = 'Ae_Controller_Std_Admin_Template';
	...
	function applyState(Ae_Controller_Context_Http $c) {
	...
	function executeManager() {
	    ...
	    if (in_array($mapperId, $mapperClasses)) {
            ...
            $context = new Ae_Controller_Context_Http($contextOptions);
