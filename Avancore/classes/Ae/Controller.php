...
class Ae_Controller {
     ...
     * @access protected 
     */
    var $_defaultResponseClass = 'Ae_Controller_Response_Html';
    ...
    /**
     * @var Ae_Controller_Context_Info 
     */
    var $_contextInfo = false;
    
    /**
     * @var Ae_Controller_Response
     */
    var $_response = false;
    ...
    /**
     * @param Ae_Controller_Context $context
     */
    function __construct ($context = null, $options = array(), $instanceId = false) {
    	...
    	if (!(is_object($context) && $context instanceof Ae_Controller_Context)) {
            ...
            $context = new Ae_Controller_Context_Http();
    ...
    /**
     * @return Ae_Controller_Context_Info
     */
    ...
    function getUrl($extraParams = array()) {
        $res = false;
        if (is_a($this->_context, 'Ae_Controller_Context_Http')) {
    ...
    /**
     * @return Ae_Controller_Response_Html
     */
