...
class Ae_Sql_Extension {
	...
	function & factory($options = array(), $class = 'Ae_Sql_Extension') {
		$res = & Ae_Util::factoryWithOptions($options, $class);
		return $res;
	}
	
	function Ae_Sql_Extension($options = array()) {
