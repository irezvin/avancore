...
/**
 * Responsible for connection of Ae_Admin_Manager with underlying model.
 */
class Ae_Admin_Datalink {
   ...
   function & factory ($params = array()) {
       ...
       if (!is_a($res, 'Ae_Admin_Datalink')) trigger_error ("'$class' is not descendant of Ae_Admin_Datalink", E_USER_ERROR);
       return $res; 
   }
   
   function Ae_Admin_Datalink($params = array()) {
       Ae_Util::simpleBind($params, $this);
   }
    ...
    * @param Ae_Admin_Processing $processing
    */
