...
abstract class Ae_Tree_AbstractImpl extends Ae_Autoparams implements Ae_I_Tree_Node {
    ...
    function setContainer(Ae_Model_Object $container = null) {
    ...
    function notifyChildNodeAdded(Ae_I_Tree_Node $childNode) {
    ...
    function notifyChildNodeRemoved(Ae_Tree_NestedSetsImpl $childNode) {
    ...
    function notifyChildNodeSaved(Ae_Tree_NestedSetsImpl $childNode) {
...
//        Ae_Debug_FirePHP::getInstance()->log($log, 'getParentIdIfChanged()');
    ...
    protected function getOrderingIfChanged($parentIsChanged = false) {
        ...
        Ae_Debug_FirePHP::getInstance()->log(array(
        	"Item #" => $this->getNodeId(),
        ...
        if (!$this->lockErrors) { 
            ...
            if (($newId = $this->getParentIdIfChanged()) !== false) {
                ...
                if ($withContainer && $this->hasToStoreContainer()) {
                    Ae_Util::ms($errors, $this->container->getErrors());
                }
