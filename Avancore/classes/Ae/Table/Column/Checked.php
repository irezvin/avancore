...
class Ae_Table_Column_Checked extends Ae_Table_Column {
    function getTitle() {
        $attribs = array(
            'type' => 'checkbox',
            'name' => 'toggle',
        ...
        $res  =  "<input ".Ae_Util::mkAttribs($attribs)." />"
                ."<input ".Ae_Util::mkAttribs(array('type' => 'hidden', 'name' => 'boxchecked', 'value' => '0'))." />";
        return $res;
    }
