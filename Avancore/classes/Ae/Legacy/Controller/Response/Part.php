...
/**
 * Response_Part is an aggregate of Ae_Legacy_Controller_Response that is evaluated only on response output.
 * 
 ...
 */
class Ae_Legacy_Controller_Response_Part extends Ae_Autoparams {
     ...
     * @see Ae_Autoparams::factory()
     */
    static function factory($signature) {
        if (is_object($signature) && $signature instanceof Ae_Legacy_Controller_Response_Part) $res = $signature;
            elseif (is_array($signature)) $res = Ae_Autoparams::factory($signature, 'Ae_Legacy_Controller_Response_Part');
            else $res = Ae_Autoparams::factory(array('class' => (string) $signature), 'Ae_Legacy_Controller_Response_Part');
        return $res;
    }
     ...
     */
    function handleResponseWakeup(Ae_Legacy_Controller_Response $response) {
    }
