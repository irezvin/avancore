...
class Ae_Test_Model_Tag_Base_Object extends Ae_Model_Object {
    ...
    var $_mapperClass = 'Ae_Test_Model_Tag_Mapper';
    
    function Ae_Test_Model_Tag_Base_Object() {
        parent::Ae_Model_Object ('#__tags', 'tagId');
    }
