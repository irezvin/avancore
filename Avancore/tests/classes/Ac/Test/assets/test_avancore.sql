...
--
-- Host: localhost    Database: test_avancore
-- ------------------------------------------------------
...
CREATE TABLE `ac_relations` (
  ...
  KEY `FK_ac_relations_1` (`personId`),
  KEY `FK_ac_relations_2` (`otherPersonId`),
  KEY `FK_ac_relations_3` (`relationTypeId`),
  CONSTRAINT `FK_ac_relations_1` FOREIGN KEY (`personId`) REFERENCES `ac_people` (`personId`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_ac_relations_2` FOREIGN KEY (`otherPersonId`) REFERENCES `ac_people` (`personId`) ON DELETE CASCADE ON UPDATE CASCADE,
...
-- Dump completed on 2009-12-22 19:08:33
