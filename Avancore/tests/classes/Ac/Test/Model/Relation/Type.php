...
Ac_Dispatcher::loadClass('Ac_Test_Model_Relation_Type_Base_Object');

class Ac_Test_Model_Relation_Type extends Ac_Test_Model_Relation_Type_Base_Object {
    
    /*
    function getOwnPropertiesInfo() {
        return Ac_Util::ms(parent::getOwnPropertiesInfo(), array(
            '' => array(
                'caption' => '',
                'dataType' => '',
                'controlType' => '',
