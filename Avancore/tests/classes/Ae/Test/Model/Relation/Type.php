...
Ae_Dispatcher::loadClass('Ae_Test_Model_Relation_Type_Base_Object');

class Ae_Test_Model_Relation_Type extends Ae_Test_Model_Relation_Type_Base_Object {
    
    /*
    function getOwnPropertiesInfo() {
        return Ae_Util::ms(parent::getOwnPropertiesInfo(), array(
            '' => array(
                'caption' => '',
                'dataType' => '',
                'controlType' => '',
