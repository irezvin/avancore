...
class Ae_Test_Adapter extends Ae_Test_Base {
    ...
    function testAdapter() {
        ...
        $configFilesToLoad = array(
            ...
            realpath($deployDir.'/Ae_Application_Adapter.adapter.config.php'),
        );
        
        $adapter = new Ae_Application_Adapter(array(
        ...
        $fooAdapter = new Ae_Application_Adapter(array('appClassFile' => $appClassFile, 'varFlagsPath' => $badPath));
        ...
        $fooAdapter2 = new Ae_Application_Adapter(array('appClassFile' => $appClassFile, 'varFlagsPath' => $badPath, 'checkDirs' => false));
        $this->assertEqual($fooAdapter2->getVarFlagsPath(), $badPath);
        
        // Test proper directory validation
        
        $fooAdapter3 = new Ae_Application_Adapter(array('appClassFile' => $appClassFile, 'varFlagsPath' => $deployDir, 'checkDirs' => true));
