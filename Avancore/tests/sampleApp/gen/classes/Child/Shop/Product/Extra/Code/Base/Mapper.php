...
class Child_Shop_Product_Extra_Code_Base_Mapper extends Sample_Shop_Product_Extra_Code_ImplMapper {

    var $recordClass = 'Child_Shop_Product_Extra_Code'; 

    var $id = 'Child_Shop_Product_Extra_Code_Mapper'; 
    ...
    static function factory ($className = false,
        ...
        $res = Ac_Model_Mapper::getMapper('Child_Shop_Product_Extra_Code_Mapper')->createRecord($className);
        return $res;
    }
    ...
    protected function doGetRelationPrototypes() {
        return Ac_Util::m(parent::doGetRelationPrototypes(), array (
            '_people' => array (
                'srcMapperClass' => 'Child_Shop_Product_Extra_Code_Mapper',
