...
(function(win) {
	...
	var tinymce = {
		...
		_init : function() {
			...
			function getBase(n) {
				if (n.src && /tiny_mce(|_gzip|_jquery|_prototype|_full)(_dev|_src)?.web/assets/.test(n.src)) {
					if (/_(src|dev)\.web/assets/g.test(n.src))
						t.suffix = '_src';
...
*/
		...
		setStyle : function(n, na, v) {
			...
			return t.run(n, function(e) {
				...
				switch (na) {
					...
					case 'float':
						isIE ? s.styleFloat = v : web/assets/s.cssFloat = v;
						break;
		...
		setStyles : function(e, o) {
			...
			s.update_styles = ol;
			if (s.update_styles)
				t.setAttrib(e, web/assets/s.cssText);
		},
		...
		getAttrib : function(e, n, dv) {
			...
			if (n === 'style') {
				v = v || web/assets/e.style.cssText;
		...
		getClasses : function() {
			...
			function addClasses(s) {
				...
				web/assets/each(s.cssRules || s.rules, function(r) {
		...
		init : function() {
			...
			if (s.popup_css !== false) {
				if (s.popup_css)
					...
					s.popup_css = t.baseURI.toAbsolute("themes/" + s.theme + "/skins/" + s.skin + "/web/assets/dialog.css");
			}
