...
function init(ed) {
	...
	web/assets/ce.style.cssText = tinyMCEPopup.editor.dom.serializeStyle(existingStyles);
...
function setupFormData() {
	...
	selectByValue(f, 'box_float', web/assets/ce.style.cssFloat || ce.style.styleFloat, true, true);
...
function applyAction() {
	...
	var newStyles = web/assets/tinyMCEPopup.editor.dom.parseStyle(ce.style.cssText);
...
function generateCSS() {
	...
	web/assets/ce.style.cssFloat = f.box_float.value;
	...
	web/assets/ce.style.cssText = web/assets/ce.style.cssText;
}
