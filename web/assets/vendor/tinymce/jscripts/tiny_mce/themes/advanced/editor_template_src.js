	...
	tinymce.create('tinymce.themes.AdvancedTheme', {
		...
		init : function(ed, url) {
			...
			if (ed.settings.content_css !== false)
				ed.contentCSS.push(ed.baseURI.toAbsolute(url + "/skins/" + ed.settings.skin + "/web/assets/content.css"));
			...
			DOM.loadCSS(s.editor_css ? ed.documentBaseURI.toAbsolute(s.editor_css) : url + "/skins/" + ed.settings.skin + "/web/assets/ui.css");
