...
class Ac_Controller_Response {
    ...
    /**
     * @var array of Ac_Controller_Response_Part
     */
    var $parts = array();
    ...
    function copyFrom(Ac_Controller_Response $otherResponse) {
     ...
     * 
     * $partSignature can be either a string - a class name; an array - an Ac_Controller_Response_Part prototype; or a ready
     * Ac_Controller_Response_Part instance itself.
     * 
     * @param $data Part data
     * @param string|array|Ac_Controller_Response_Part $partSignature
     ...
     */
    function createPlaceholder($data, $partSignature = 'Ac_Controller_Response_Part', $appendToContent = false) {
        $p = $this->findPart($partSignature);
        if (!$p) {
            $p = Ac_Controller_Response_Part::factory($partSignature);
            $this->parts[] = $p;
        }
