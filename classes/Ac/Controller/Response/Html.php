...
class Ac_Controller_Response_Html extends Ac_Controller_Response_Http {
    ...
    /**
     * @param Ac_Controller_Response_Html $subResponse
     */
...
//            if ($this !== Ac_Controller_Response_Global::r()) {
//                Ac_Controller_Response_Global::i()->pourToResponse($this);
//            }
//        }
        $res = parent::__sleep();
        return $res;
