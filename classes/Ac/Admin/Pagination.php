...
class Ac_Admin_Pagination extends Ac_Controller {
    ...
    var $_templateClass = 'Ac_Admin_Template_Pagination';
    
    /**
     * @var Ac_Admin_Template_Pagination
     */
    var $_template = false;
    ...
    function getPageNo() {
        ...
        if ($this->_currentPageNo === false) {
            ...
            $this->_currentPageNo = max([$this->_currentPageNo, 0]);
        }
