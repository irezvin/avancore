 ...
 */
class Ac_Legacy_Controller_Response_JsonPart extends Ac_Legacy_Controller_Response_Part {
    ...
    /**
     * (non-PHPdoc)
     * @see Ac_Legacy_Controller_Response_Part::createPlaceholder()
     * 
