...
define('AC_HACKS_EXPOSE', '_hck_expose');
...
class Ac_Hacks {
	 ...
	 * @return object
	 * 
	 * This method is intended to be called by Ac_Hacks descendants
	 * <code>
	 * 		class Foo_Hacks extends Ac_Hacks {
	 * 			// ...
	 * 			function getInstance() {
	 * 				return Ac_Hacks::getInstance('Foo_Hacks');
	 * 			} 
	 * 			// ..
	 * 		}
	 * </code>
...
//		}
		...
		if (!isset($b[1]['file'])) { 
			//if ($this->_hck_isCallParent) {
			if (isset($b[3]) && isset($b[3]['class']) && (!strcasecmp($b[3]['class'], 'Ac_Hacks'))) {
...
//				}
	...
	function & __get($name) {
		...
		if ($this->_hck_context) {
			if (isset($this->_hck_contextCaps[$v = AC_HACKS_EXPOSE])) {
