...
class Ae_Param_Block extends Ae_Autoparams {
    ...
    protected function assignSource ($params, $oldSource = null) {
        foreach ($params as $param) {
            if (is_object($param) && $param instanceof Ae_I_Param_WithSource) {
    ...
    function getParam($id) {
        ...
        if (isset($this->params[$id])) {
            if (!is_object($this->params[$id])) {
                 if (!isset($this->params[$id]['class'])) $this->params[$id]['class'] = 'Ae_Param';
                 ...
                 $this->params[$id] = Ae_Autoparams::factory($this->params[$id], 'Ae_I_Param');
                 if ($this->source && $this->params[$id] instanceof Ae_I_Param_WithSource && !$this->params[$id]->getSource()) {
