...
class Ae_Model_Collection {
    ...
    /**
     * Cursor records. 
     * @var array (className => Ae_Model_Object)
     */
    var $_cursor = array();
    ...
    function Ae_Model_Collection ($mapperClass = false, $matchingKeys = false, $where = false, $order = false, $joins = false, $extraColumns = false, $limitOffset = false, $limitCount = false) {
     ...
     * @param array of Ae_Model_Data $records
     */
