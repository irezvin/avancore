...
class Ae_Debug_Log_FileWriter extends Ae_Debug_Log_AbstractWriter {
    ...
    function guessDir() {
        if (class_exists('Ae_Dispatcher', false) && Ae_Dispatcher::hasInstance())
            $res = Ae_Dispatcher::getInstance()->config->cachePath;
    ...
    function write(Ae_Debug_Log $log = null, array $args) {
