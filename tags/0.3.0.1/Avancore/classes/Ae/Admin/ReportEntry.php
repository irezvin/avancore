...
class Ae_Admin_ReportEntry {
    ...
    function Ae_Admin_ReportEntry ($description = false, $type = 'message', $dateTime = false, $recordKey = false, $recordTitle = false, $recordIsAvailable = false) {
        if (func_num_args() == 1 && is_array($description)) Ae_Util::simpleBind($description, $this);
        else {
    ...
    /**
     * @param Ae_Admin_ReportEntry $entry
     */
