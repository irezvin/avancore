...
/**
 * Updated Ae_Controller with best things taken from my recent projects.
 * Has JSON support, method chaining, output capture, exception handling and caching.
 */
class Ae_Controller_Std_Web extends Ae_Controller {
    ...
    protected function loadFromCache() {
        ...
        if (strlen($id = $this->getCacheId())) {
            ...
            if (is_array($val)) {
                ...
                if (isset($val['_response']) && $val['_response'] instanceof Ae_Controller_Response) {
        ...
        try {
            ...
            if ($this->_response === false) {
                if ($this->isJson || $this->forceJson) {
                    $this->_defaultResponseClass = 'Ae_Controller_Response_Json';
                }
                parent::getResponse();
                if ($this->isJson || $this->forceJson) {
                    $resp = $this->_response;
                    $res = new Ae_Controller_Response_Json();
