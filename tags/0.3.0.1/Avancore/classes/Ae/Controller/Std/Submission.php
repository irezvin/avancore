...
class Ae_Controller_Std_Submission extends Ae_Controller {
    
    /**
     * @var Ae_Controller_Std_Submission_Template
     */
    var $_template = false;
    
    var $_templateClass = 'Ae_Controller_Std_Submission_Template';
    ...
    function doInitProperties($options = array()) {
        Ae_Dispatcher::loadClass('Ae_Controller_Filter');
        $this->_filter = new Ae_Controller_Filter;
    }
     ...
     * @return array(prototypes for Ae_Controller_Std_Submission_Sendout)
     */
     ...
     * @access protected
     * @param Ae_Mail $mail
     * @param Ae_Controller_Std_Submission_Sendout $sendout
     * @return bool
     */
    ...
    function notifyRecipients() {
        Ae_Dispatcher::loadClass('Ae_Controller_Std_Submission_Sendout');
        foreach ($this->doGetSendouts() as $sendoutPrototype) {
            $sendout = new Ae_Controller_Std_Submission_Sendout($this, $this->getModelObject(), $this->getTemplate(), $sendoutPrototype);
