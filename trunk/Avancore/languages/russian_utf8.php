...
if (!defined ('AE_SELECT_ELEMENTS_TO_UNPUBLISH')) define ('AE_SELECT_ELEMENTS_TO_UNPUBLISH', 'Пожалуйста, выберите элемент(ы) для снятия с публикации');
...
if (!defined('AE_ADMIN_PAGINATION_PREV_N_PAGES')) define ('AE_ADMIN_PAGINATION_PREV_N_PAGES', '&lt;&lt; Пред. %d стр.');
if (!defined('AE_ADMIN_PAGINATION_NEXT_N_PAGES')) define ('AE_ADMIN_PAGINATION_NEXT_N_PAGES', 'След. %d стр. &gt;&gt;');
if (!defined('AE_ADMIN_PAGINATION_PREV_PAGE')) define ('AE_ADMIN_PAGINATION_PREV_PAGE', '&lt; Пред. стр. ');
if (!defined('AE_ADMIN_PAGINATION_NEXT_PAGE')) define ('AE_ADMIN_PAGINATION_NEXT_PAGE', 'След. стр. &gt;');
if (!defined('AE_ADMIN_PAGINATION_SHOWING')) define ('AE_ADMIN_PAGINATION_SHOWING', 'Отображено');
if (!defined('AE_ADMIN_PAGINATION_OF')) define ('AE_ADMIN_PAGINATION_OF', 'из');
if (!defined('AE_ADMIN_PAGINATION_SHOW_QTY')) define ('AE_ADMIN_PAGINATION_SHOW_QTY', 'Показать ');
if (!defined('AE_ADMIN_PAGINATION_RECORDS')) define ('AE_ADMIN_PAGINATION_RECORDS', 'записей');

if (!defined('AE_ID_EMPTY_CAPTION')) define('AE_ID_EMPTY_CAPTION', 'Id будет назначен при сохранении записи');

if (!defined('AE_ADMIN_CREATE_NEW_RECORD_CAPT')) define('AE_ADMIN_CREATE_NEW_RECORD_CAPT', 'Создать');
if (!defined('AE_ADMIN_CREATE_NEW_RECORD_DESCR')) define('AE_ADMIN_CREATE_NEW_RECORD_DESCR', 'Создать новую запись');
if (!defined('AE_ADMIN_EDIT_RECORD_CAPT')) define('AE_ADMIN_EDIT_RECORD_CAPT', 'Изменить');
if (!defined('AE_ADMIN_EDIT_RECORD_DESCR')) define('AE_ADMIN_EDIT_RECORD_DESCR', 'Изменить выбранную запись');
if (!defined('AE_ADMIN_DELETE_RECORD_CAPT')) define('AE_ADMIN_DELETE_RECORD_CAPT', 'Удалить');
if (!defined('AE_ADMIN_DELETE_RECORD_DESCR')) define('AE_ADMIN_DELETE_RECORD_DESCR', 'Удалить одну или несколько выбранных записей');
if (!defined('AE_ADMIN_DELETE_RECORD_CONFIRM')) define('AE_ADMIN_DELETE_RECORD_CONFIRM', 'Удалить выбранные записи?');
if (!defined('AE_ADMIN_APPLY_CAPT')) define('AE_ADMIN_APPLY_CAPT', 'Применить');
if (!defined('AE_ADMIN_APPLY_DESCR')) define('AE_ADMIN_APPLY_DESCR', 'Применить изменения');
if (!defined('AE_ADMIN_SAVE_CAPT')) define('AE_ADMIN_SAVE_CAPT', 'Сохранить');
if (!defined('AE_ADMIN_SAVE_DESCR')) define('AE_ADMIN_SAVE_DESCR', 'Сохранить изменения и вернуться из режима формы');
if (!defined('AE_ADMIN_SAVE_ADD_CAPT')) define('AE_ADMIN_SAVE_ADD_CAPT', 'Сохр+Созд');
if (!defined('AE_ADMIN_SAVE_ADD_DESCR')) define('AE_ADMIN_SAVE_ADD_DESCR', 'Сохранить изменения и создать новую запись');
if (!defined('AE_ADMIN_CANCEL_CAPT')) define('AE_ADMIN_CANCEL_CAPT', 'Отменить');
if (!defined('AE_ADMIN_CANCEL_DESCR')) define('AE_ADMIN_CANCEL_DESCR', 'Отменить изменения и вернуться из режима формы');
