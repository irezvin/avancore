...
Ae_AjaxModule_ElementDialog = function(options) {
    
    Ae_AjaxModule_Dialog.call(this, options);
    
};

Ae_AjaxModule_ElementDialog.prototype = {
    ...
    acceptJson: function(json) {
        this.getElement();
        return Ae_AjaxModule_Dialog.prototype.acceptJson.call(this, json);
    },
...
Ae_Util.extend(Ae_AjaxModule_ElementDialog, Ae_AjaxModule_Dialog);