...
-->'
   ...
   function testEmptyConsolidatedResponseMergedWithHtml() {
       ...
       $e = new Ac_Response_Environment_Dummy;
       $w->setEnvironment($e);
       $w->writeResponse($cons);
       $this->assertIdentical($e->responseText, '<!DOCTYPE html>
<html>
    <head>
    </head>
    <body></body>
...
');
    ...
    function testStructuredTextMerge() { // FAILS!!!
        ...
        // What to do? Merging is not properly done
        
        $reg = new Ac_Response;
        $reg->setContent(new Ac_Content_StructuredText);
        $reg->setContent(array(
            '<body>', 
            'body' => array(), 
            '</body>',
        ));
