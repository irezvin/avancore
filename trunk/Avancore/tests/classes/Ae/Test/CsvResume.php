...
class Ae_Test_CsvResume extends UnitTestCase {
	...
	function testCsvResume() {
            ...
            if (!is_file($serFile)) {
	            ...
	            $imexOptions = array(
	                'defaultModuleClass' => 'Ae_Imex_Module_Basic',
	                'modules' => $moduleSettings,
	            );
	            $processor = new Ae_Imex_Processor($imexOptions);
	            $storage = & Ae_Imex_Storage::factory($storageOptions, $this->processor);
