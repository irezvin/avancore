...
class Ac_Model_DateTime {
    ...
    static function getDateTranslations() {
        ...
        if (!class_exists('Ac_Lang_String', false)) {
            return array();
        }
        ...
        if ($englishMonths === false) {
            ...
            $localeMonths = explode('|', new Ac_Lang_String('locale_months_long', implode('|', $englishMonths)));
            $localeMonthShorts = explode('|', new Ac_Lang_String('locale_months_short', implode('|', $englishMonthShorts)));
    ...
    function match($inputString, $userMask = false) {
        ...
        if ($matches) {
            ...
            if (isset($res['month']) && !is_numeric($res['month'])) {
                $months = $this->months;
                if (class_exists('Ac_Lang_String', false)) {
                    $months = (string) new Ac_Lang_String('locale_months_short', $months);
                } else {
                }
