...
class Ac_Sql_Filter_Multiple extends Ac_Sql_Filter {
    ...
    /**
     * Usually the Ac_Sql_Filter_Multiple accepts array (childName => childValue); but if this property is TRUE, it just sets assigned value to each child filter. 
     * @var bool
     */
