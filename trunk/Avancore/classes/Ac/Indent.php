...
class Ac_Indent extends Ac_Autoparams {
    ...
    static function getInstance() {
        if (!self::$instance) {
            self::$instance = new Ac_Indent();
            self::$instance->setCache(new Ac_Indent_Cache_Default());
        }
        return self::$instance;
    }

    static function setInstance(Ac_Indent $indent = null) {
        self::$instance = $indent;
    }

    /**
     * @return Ac_Indent_Cache
     */
    function getCache() {
        return $this->cache;
    }

    function setCache(Ac_Indent_Cache $cache = null) {
        $this->cache = $cache;
    }
    ...
    static function s($text) {
        Ac_Indent::getInstance()->show($text);
    }

    static function si($indent, $text) {
        Ac_Indent::getInstance()->showWithIndent($indent, $text);
    }
