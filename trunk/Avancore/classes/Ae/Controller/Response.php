...
class Ae_Controller_Response {
    ...
    /**
     * @var array of Ae_Controller_Response_Part
     */
    var $parts = array();
    ...
    function copyFrom(Ae_Controller_Response $otherResponse) {
     ...
     * 
     * $partSignature can be either a string - a class name; an array - an Ae_Controller_Response_Part prototype; or a ready
     * Ae_Controller_Response_Part instance itself.
     * 
     * @param $data Part data
     * @param string|array|Ae_Controller_Response_Part $partSignature
     ...
     */
    function createPlaceholder($data, $partSignature = 'Ae_Controller_Response_Part', $appendToContent = false) {
        $p = $this->findPart($partSignature);
        if (!$p) {
            $p = Ae_Controller_Response_Part::factory($partSignature);
            $this->parts[] = $p;
        }
    ...
    /**
     * @param string|array|Ae_Controller_Response_Part $partSignature
     * @return Ae_Controller_Response_Part
     */
