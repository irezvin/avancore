...
class Ae_Controller_Std_Submission_Sendout {
    ...
    /**
     * @var Ae_Controller_Std_Submission
     */
    ...
    /**
     * @param Ae_Controller_Std_Submission $submission Controller that processes object submission from the Web
     ...
     * @return Ae_Controller_Std_Submission_Sendout 
     */
    function Ae_Controller_Std_Submission_Sendout (& $submission, & $modelObject, & $template, $prototype = array()) {
