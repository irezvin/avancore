...
class Ae_Table_Column_SaveOrder extends Ae_Table_Column {
    ...
    function showHeader($rowCount, $rowNo) {
        ...
        <th <?php echo Ae_Util::mkAttribs($this->getHeaderAttribs($rowCount, $rowNo)); ?> > <a href="javascript: saveOrderWithTask( <?php echo count( $this->_table->listRecords() )-1; ?>, '<?php echo addslashes($this->getTaskName()); ?>' )"><img src="images/filesave.png" border="0" width="16" height="16" alt=ACLT_SAVE_ORDER /></a></th>
        <?php
    }
