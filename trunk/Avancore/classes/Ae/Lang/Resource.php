...
class Ae_Lang_Resource {
    ...
    /**
     * @param Ae_I_Lang_ResourceProvider | array $resourceProviders One or many resource provider (also any number of arguments can be specified)
     * @return array List of current resource providers
     */
    function setResourceProviders($resourceProviders) {
    	$args = func_get_args();
    	$providers = Ae_Util::flattenArray($args);
	...
	static function setInstance(Ae_Lang_Resource $instance) {
		self::$instance = $instance;
	}
	
	/**
	 * @return Ae_Lang_Resource
	 */
	static function getInstance() {
		if (!self::$instance) self::setInstance(new Ae_Lang_Resource);
