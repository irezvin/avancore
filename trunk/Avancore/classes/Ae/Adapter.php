...
class Ae_Adapter {
    ...
    function Ae_Adapter($extraSettings = array()) {
    ...
    function getSession() {
        if ($this->_session === false) {
            if ($this->sessionClass === false) trigger_error ('$sessionClass is not specified in conrete Ae_Adapter instance', E_USER_ERROR);          
