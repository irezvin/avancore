 ...
 *
 */
class Ae_Form_Converter { 
    
    /**
     * @param Ae_Model_Property $property
     */
    function getControlSettings(& $property) {
        ...
        switch(true) {
            ...
            case $property->dataType == 'dateTime':
                $conf['class'] = 'Ae_Form_Control_DateTime';
                break;
                
            case $property->dataType == 'date':
                $conf['class'] = 'Ae_Form_Control_Date';
                break;
                
            case $property->dataType == 'bool':
                $conf['class'] = 'Ae_Form_Control_Toggle';
                break;
            
            case $property->controlType === 'selectList':
                $conf['class'] = 'Ae_Form_Control_List';
                ...
                break;
            default:
                $conf['class'] = 'Ae_Form_Control_Text';
                break;
        }
